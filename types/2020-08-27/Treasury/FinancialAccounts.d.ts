  ...
  namespace Stripe {
    namespace Treasury {
      ...
      interface FinancialAccount {
         ...
         */
        account_closed_reasons: Array<FinancialAccount.AccountClosedReason>;
         ...
         *
         * [Stripe Treasury](https://stripe.com/treasury) is currently in beta development. Members of the beta program have access to FinancialAccount Features APIs.
         */
      ...
      namespace FinancialAccountCreateParams {
        ...
        namespace Features {
          ...
          interface InboundTransfers {
            ...
            /**
             * Enables cards via the InboundTransfers API.
             */
            card?: InboundTransfers.Card;
          }
      ...
      interface FinancialAccountFeaturesParams {
        /**
         * Represents whether this FinancialAccount is eligible for deposit insurance. Various factors determine the insurance amount.
         */
        deposit_insurance?: FinancialAccountFeaturesParams.DepositInsurance;
         ...
         * Contains Features that add FinancialAddresses to the FinancialAccount.
         */
        financial_addresses?: FinancialAccountFeaturesParams.FinancialAddresses;

        /**
         * Contains settings related to adding funds to a FinancialAccount from another Account with the same owner.
         */
        inbound_transfers?: FinancialAccountFeaturesParams.InboundTransfers;

        /**
         * Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
         */
        intra_stripe_flows?: FinancialAccountFeaturesParams.IntraStripeFlows;

        /**
         * Includes Features related to initiating money movement out of the FinancialAccount to someone else's bucket of money.
         */
        outbound_payments?: FinancialAccountFeaturesParams.OutboundPayments;

        /**
         * Contains a Feature and settings related to moving money out of the FinancialAccount into another Account with the same owner.
         */
        outbound_transfers?: FinancialAccountFeaturesParams.OutboundTransfers;
      }

      namespace FinancialAccountFeaturesParams {
        interface DepositInsurance {
          /**
           * Whether the FinancialAccount should have the Feature.
           */
      ...
      class FinancialAccountsResource {
        ...
        /**
         * Updates Features information associated with a FinancialAccount.
         *
         * SDK support for languages shown in examples (other than cURL) coming soon.
         */
        features(
          id: string,
          params?: FinancialAccountFeaturesParams,
          options?: RequestOptions
