  ...
  namespace Stripe {
    namespace Treasury {
      ...
      class OutboundTransfersResource {
        ...
        /**
         * Retrieves the details of an existing OutboundTransfer. Supply the unique OutboundTransfer ID from either the OutboundTransfer creation request or OutboundTransfer list, and Stripe returns the corresponding OutboundTransfer information.
         *
         * SDK support for languages shown in examples (other than cURL) coming soon.
         */
        retrieve(
