  ...
  namespace Stripe {
    namespace Treasury {
      ...
      class CreditReversalsResource {
        ...
        /**
         * Retrieves the details of an existing CreditReversal. Supply the unique CreditReversal ID from either the CreditReversal creation request or CreditReversal list, and Stripe returns the corresponding CreditReversal information.
         *
         * SDK support for languages shown in examples (other than cURL) coming soon.
         */
        retrieve(
