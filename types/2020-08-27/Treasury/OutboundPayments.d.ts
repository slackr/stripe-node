  ...
  namespace Stripe {
    namespace Treasury {
      ...
      class OutboundPaymentsResource {
        ...
        /**
         * Retrieves the details of an existing OutboundPayment. Supply the unique OutboundTransfer ID from either the OutboundPayment creation request or OutboundPayment list, and Stripe returns the corresponding OutboundPayment information.
         *
         * SDK support for languages shown in examples (other than cURL) coming soon.
         */
        retrieve(
