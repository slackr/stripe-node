    ...
    namespace Treasury {
      ...
      namespace ReceivedCredit {
        ...
        interface LinkedFlows {
          ...
          /**
           * Set if the ReceivedCredit is also viewable as an [Issuing Dispute](https://stripe.com/docs/api#issuing_disputes) object.
           */
      ...
      class ReceivedCreditsResource {
        /**
         * Retrieves the details of an existing ReceivedCredit. Supply the unique ReceivedCredit ID from the ReceivedCredit list, and Stripe returns the corresponding ReceivedCredit information.
         *
