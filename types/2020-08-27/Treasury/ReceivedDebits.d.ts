  ...
  namespace Stripe {
    namespace Treasury {
      ...
      class ReceivedDebitsResource {
        /**
         * Retrieves the details of an existing ReceivedDebit. Supply the unique ReceivedDebit ID from the ReceivedDebit list, and Stripe returns the corresponding ReceivedDebit information.
         *
