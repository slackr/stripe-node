  ...
  namespace Stripe {
    namespace Treasury {
      ...
      interface InboundTransfer {
        ...
        /**
         * Current status of the InboundTransfer: `processing`, `succeeded`, and `failed`.
         */
      ...
      interface InboundTransferListParams extends PaginationParams {
        ...
        /**
         * Only return InboundTransfers that have the given status: `processing`, `succeeded`, or `failed`.
         */
      ...
      class InboundTransfersResource {
        ...
        /**
         * Retrieves the details of an existing InboundTransfer. Supply the unique InboundTransfer ID from either the InboundTransfer creation request or InboundTransfer list, and Stripe returns the corresponding InboundTransfer information.
         *
         * SDK support for languages shown in examples (other than cURL) coming soon.
         */
        retrieve(
